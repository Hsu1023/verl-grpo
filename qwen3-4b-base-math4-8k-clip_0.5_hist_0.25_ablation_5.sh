...
#SBATCH --mem=350G
#SBATCH --time=8:00:00
#SBATCH -J qwen3-4b-base-math4-8k-clip_0.5_hist_0.25_ablation_5
...
exp_name=qwen3-4b-base-math4-8k-clip_0.5_hist_0.25_ablation_5
