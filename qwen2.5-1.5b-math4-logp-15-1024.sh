...
exp_name=qwen2.5-1.5b_grpo_1e-6_math4_logp_15_1024
...
logp_threshold=15
logp_kwargs="{override_config:{top_k: 0, logprobs:20, prompt_logprobs:20},logp_config: {enable_conf: true,window_size: 1024,threshold: $logp_threshold}}"
