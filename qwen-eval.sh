...
# VAL_FILES="['$gsm8k_path']"
# VAL_FILES="['/home/yichen/verl/data/gsm8k/train.parquet']"
VAL_FILES="['/home/yichen/verl/data/dapo17k/train.parquet']"
# VAL_FILES="['/home/yichen/verl/data/gsm8k/train.parquet', '/home/yichen/verl/data/mathlighteval/train_level1.parquet', '/home/yichen/verl/data/mathlighteval/train_level2.parquet', '/home/yichen/verl/data/mathlighteval/train_level3.parquet', '/home/yichen/verl/data/mathlighteval/train_level4.parquet', '/home/yichen/verl/data/mathlighteval/train_level5.parquet']"
...
CUDA_VISIBLE_DEVICES=4 python3 -m verl.trainer.main_ppo \
    ...
    trainer.total_epochs=0 "$@" 2>&1 | tee -a $HOME/verl/checkpoints/$exp_name/train.log
    #  \
