...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", default="/home/yichen/verl/data/dapo17k")
    parser.add_argument("--hdfs_dir", default=None)

    args = parser.parse_args()

    data_path = "open-r1/DAPO-Math-17k-Processed"
    train_dataset = datasets.load_dataset(data_path, 'en', split='train')
    # test_dataset = datasets.load_dataset(data_path, split='test')
