...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", default="/home/yichen/verl/data/aime2025")
    ...
    ds_a = datasets.load_dataset(data_path, "AIME2025-I", split="test")
    ds_b = datasets.load_dataset(data_path, "AIME2025-II", split="test")
    common_cols = list(set(ds_a.column_names) & set(ds_b.column_names))
    ds_a = ds_a.select_columns(common_cols)
    ds_b = ds_b.select_columns(common_cols)
