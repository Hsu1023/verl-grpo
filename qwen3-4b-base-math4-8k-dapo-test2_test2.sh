...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/u/haoboxu/work/verl/checkpoints/merged_checkpoints/qwen3_1.7b_0.5_p0.4/global_step_300 \
    ...
    +trainer.probe_warmup_steps=2 \
    +trainer.probe_stop_token_num=300 \
