...
#SBATCH -J qwen3-4b_base_grpo_1e-6_math4_16k_clip_0.5_hist_0.499
...
exp_name=qwen3-4b_base_grpo_1e-6_math4_16k_clip_0.5_hist_0.499
...
python3 -m verl.trainer.main_ppo \
    ...
    +trainer.probe_stop_token_num=1024 \
