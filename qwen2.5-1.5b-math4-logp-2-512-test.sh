...
exp_name=qwen2.5-1.5b_grpo_1e-6_math4_logp_2_512_test
...
logp_threshold=15
# logp_kwargs="{'override_config':{'top_k': 0},'logp_config': {'enable_conf': true,'window_size': 2048,'threshold': $logp_threshold}}"
