...
#SBATCH -J qwen3-4b_base_grpo_1e-6_diameter
...
exp_name=qwen3-4b_base_grpo_1e-6_diameter
project_name='verl_grpo_example_gsm8k'


TRAIN_FILES=$BASE_PATH/data/diameter.parquet
VAL_FILES=$BASE_PATH/data/diameter_example.parquet
