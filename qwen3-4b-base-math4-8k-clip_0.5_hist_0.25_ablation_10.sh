...
#SBATCH --mem=350G
#SBATCH --time=8:00:00
#SBATCH -J qwen3-4b-base-math4-8k-clip_0.5_hist_0.25_ablation_10
...
exp_name=qwen3-4b-base-math4-8k-clip_0.5_hist_0.25_ablation_10
...
python3 -m verl.trainer.main_ppo \
    ...
    +reward_model.reward_kwargs.max_resp_len=7680 \
    actor_rollout_ref.actor.fsdp_config.use_orig_params=True \
    actor_rollout_ref.ref.fsdp_config.use_orig_params=True \
    +trainer.probe_warmup_steps=10 \
    ...
    trainer.total_training_steps=51 "$@" 2>&1 | tee -a $BASE_PATH/checkpoints/$exp_name/train.log
    #  \
